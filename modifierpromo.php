          ...
          <form method="POST" name="f" class="form-horizontal" onsubmit="return verif()">
            <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="number" value="<?PHP echo $id_promo ?>" placeholder=" --- " data-title="Juste a number for the Id promotion…" class="span11 tip" data-original-title="" name="id_promo" >
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="number" value="<?PHP echo $prix ?>" class="span11 tip" data-original-title="" name="prix" id="required">
                      </div>
                    </div>
...
if (isset($_POST['modifier'])){
	$promo=new promo($_POST['id_promo'],$_POST['prix'],$_POST['reduc']);
	$promoC->modifierPromo($promo,$_POST['id_promo_ini']);
