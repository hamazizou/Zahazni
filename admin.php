            ...
            <div class="header-menu">
                ...
                <div class="col-sm-7">
                    ...
                    <div class="header-left">
                        ...
                        <!-- Message -->
                        <div class="container">
                        <?php $mysqli = new mysqli('localhost', 'root','', 'g_reclamation' ) or die(mysqli_error($mysqli)); 
                        $result = $mysqli->query("SELECT* FROM contact") or die ($musqli->error);
                        ?>
                        ...
                        <tr> 
                            ...
                            <td> 
                                ...
                                <a href="admin.php?delete<?php echo $row['id']; ?> "class="btn btn-danger" class="site_btn" name="delete"> Delete</a>
                        </td>
                        </tr>
                        <?php endwhile; ?> 
                                </p>
